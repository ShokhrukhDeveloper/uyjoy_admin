...
class CustomPriceFiled extends StatefulWidget {
   CustomPriceFiled(
      {super.key,required this.onChangedType, this.controller, required this.hint, required this.label, this.maxLength, required this.priceType, required this.onChangedNegotiable, required this.negotiable, required this.negotiableText});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              CupertinoSwitch(value: widget.negotiable, onChanged:(t){
